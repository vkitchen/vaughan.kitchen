...
<h2>Personal</h2>
<fieldset>
<p>Programming language enthusiast, NZ's 4th best chilli eater, brandy connoisseur, and roller skating fiend</p>
...
<p>A search engine implemented for fun. I have focused largely on optimizing the indexer bringing it down from an initial 2 minute runtime on the 500mb Wall Street Journal to the current 7 seconds. It's deployed as part of my recipe search engine but still has work much to be done on it</p>
C (search engine), OCaml (web scraper)
<a href="https://github.com/vkitchen/cocomel">source (search)</a>
<a href="https://github.com/vkitchen/scraper">source (scraper)</a>
<a href="http://potatocastles.com">demo</a>

<h3>xiangqi - Chinese Chess</h3>
<p>Originally built in 5 days of evenings as part of a work "knowledge sharing" event during covid. Most other people merely video called for their demonstration but I wanted mine to be interactive so after work hours I hacked up the game. I've since improved the lobby logic but haven't gotten around to improving the performance of the game logic and putting in place the last checkmate condition (flying emperor attack). Once I get those in place I'll add Minimax</p>
Elm
<a href="https://github.com/vkitchen/chinese-chess">source</a>
<a href="/chinese-chess">demo</a>

<h3>cocktails - A cocktail website</h3>
<p>Made during the period in which I was obsessed with recreating classic cocktails. I wanted a clean easy to use website which would allow me to search based off of ingredients and would only contain "classic" recipes. Eventually after being frustrated with the existing offers I hacked up my own. Originally it was written in Elm, but I rewrote it to be part of my personal website which is in C</p>
Elm (originally), C (deployed version)
...
<p>2019 - Present (awaiting graduation)</p>
...
<h3>TracPlus</h3>
<p>Currently I work at TracPlus doing anything and everything software. Frontend, backend, architecture and guiding the team are my current primary roles. Previously I mostly did React Native mobile development with the odd spot of React Web Development</p>
<h5>Senior Software Engineer (Jul 2021 - Present)</h5>
<h5>Full Stack Developer (Sep 2020 - Jul 2021)</h5>
<h5>Frontend Developer (Nov 2019 - Sep 2020)</h5>

<h3>Self Employed - Private Tutor</h3>
<p>Tutoring for second year Computer Science, mainly around algorithms and data structures but also some network and operating systems</p>
<p>Mar 2019 - Oct 2019 (8 mos)</p>
...
<h3>Self Employed - Freelance Web Developer with Rational Madmen contracting group</h3>
<p>Worked as a front end Web Developer with a graphic design contracting group doing rapid prototyping for web ux design. Mainly involved JQuery work with some Angular towards the end</p>
