...
var _user$project$Nav_ops = _user$project$Nav_ops || {};
_user$project$Nav_ops['=>'] = F2(
	function (v0, v1) {
		return {ctor: '_Tuple2', _0: v0, _1: v1};
	});
var _user$project$Nav$nav = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					A2(_user$project$Nav_ops['=>'], 'display', 'flex'),
					A2(_user$project$Nav_ops['=>'], 'align-items', 'center'),
					A2(_user$project$Nav_ops['=>'], 'background-color', '#f5f5f5'),
					A2(_user$project$Nav_ops['=>'], 'border-bottom', '1px solid #ddd')
				]))
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							A2(_user$project$Nav_ops['=>'], 'margin', '5px')
						]))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('VK')
				]))
		]));
var _user$project$Nav$search = A2(
	_elm_lang$html$Html$div,
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Attributes$style(
			_elm_lang$core$Native_List.fromArray(
				[
					A2(_user$project$Nav_ops['=>'], 'margin', '0 auto')
				]))
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							A2(_user$project$Nav_ops['=>'], 'border', '1px solid #ddd'),
							A2(_user$project$Nav_ops['=>'], 'background-color', '#fff'),
							A2(_user$project$Nav_ops['=>'], 'border-radius', '3px')
						]))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									A2(_user$project$Nav_ops['=>'], 'display', 'inline'),
									A2(_user$project$Nav_ops['=>'], 'border-right', '1px solid #eee'),
									A2(_user$project$Nav_ops['=>'], 'color', '#767676'),
									A2(_user$project$Nav_ops['=>'], 'padding', '0 8px 0 8px')
								]))
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('Py docs')
						])),
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									A2(_user$project$Nav_ops['=>'], 'display', 'inline'),
									A2(_user$project$Nav_ops['=>'], 'border', '0')
								]))
						]),
					_elm_lang$core$Native_List.fromArray(
						[]))
...
var _user$project$Nav$tray = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$src('/static/bell.png'),
					_elm_lang$html$Html_Attributes$style(
					_elm_lang$core$Native_List.fromArray(
						[
							A2(_user$project$Nav_ops['=>'], 'height', '20px')
						]))
				]),
			_elm_lang$core$Native_List.fromArray(
				[])),
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$src('/static/user.png'),
					_elm_lang$html$Html_Attributes$style(
					_elm_lang$core$Native_List.fromArray(
						[
							A2(_user$project$Nav_ops['=>'], 'height', '20px')
...
var _user$project$Main$delta2builder = F2(
	function (previous, current) {
		return _elm_lang$core$Maybe$Just(
			A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$core$Basics$toString(current.pageId)
					]),
				_rgrempel$elm_route_url$RouteUrl_Builder$builder));
	});
var _user$project$Main$delta2hash = F2(
	function (previous, current) {
		return A2(
			_elm_lang$core$Maybe$map,
			_rgrempel$elm_route_url$RouteUrl_Builder$toHashChange,
			A2(_user$project$Main$delta2builder, previous, current));
	});
var _user$project$Main$onTab = function (action) {
	var decoder = A2(
		_elm_lang$core$Json_Decode$customDecoder,
		_elm_lang$html$Html_Events$keyCode,
		function (k) {
			return _elm_lang$core$Native_Utils.eq(k, 9) ? _elm_lang$core$Result$Ok(action) : _elm_lang$core$Result$Err('not handling that key');
		});
...
var _user$project$Main$decodeResponse = A4(
	_elm_lang$core$Json_Decode$object3,
	F3(
		function (v0, v1, v2) {
			return {ctor: '_Tuple3', _0: v0, _1: v1, _2: v2};
		}),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'total_items', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'lesson', _elm_lang$core$Json_Decode$string),
...
var _user$project$Main$tutorial = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								A2(_user$project$Main_ops['=>'], 'margin', '20px')
							]))
					]),
				model.lesson)
			]));
};
var _user$project$Main$windowMenuStyle = _elm_lang$html$Html_Attributes$style(
	_elm_lang$core$Native_List.fromArray(
		[
			A2(_user$project$Main_ops['=>'], 'background-color', '#f5f5f5'),
			A2(_user$project$Main_ops['=>'], 'border-bottom', '1px solid #ddd'),
			A2(_user$project$Main_ops['=>'], 'display', 'flex'),
			A2(_user$project$Main_ops['=>'], 'align-items', 'center'),
			A2(_user$project$Main_ops['=>'], 'height', '30px')
		]));
var _user$project$Main$windowStyle = _elm_lang$html$Html_Attributes$style(
	_elm_lang$core$Native_List.fromArray(
		[
			A2(_user$project$Main_ops['=>'], 'flex', '1'),
			A2(_user$project$Main_ops['=>'], 'border', '1px solid #ddd'),
			A2(_user$project$Main_ops['=>'], 'border-radius', '6px'),
			A2(_user$project$Main_ops['=>'], 'margin', '6px'),
			A2(_user$project$Main_ops['=>'], 'display', 'flex'),
			A2(_user$project$Main_ops['=>'], 'flex-direction', 'column')
		]));
var _user$project$Main$window = F2(
	function (menu, content) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[_user$project$Main$windowStyle]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
						[_user$project$Main$windowMenuStyle]),
					menu),
					content
				]));
	});
var _user$project$Main$runcode = _elm_lang$core$Native_Platform.outgoingPort(
	'runcode',
	function (v) {
		return v;
	});
var _user$project$Main$inserttab = _elm_lang$core$Native_Platform.outgoingPort(
	'inserttab',
	function (v) {
		return v;
	});
var _user$project$Main$output = _elm_lang$core$Native_Platform.incomingPort('output', _elm_lang$core$Json_Decode$string);
var _user$project$Main$updatecode = _elm_lang$core$Native_Platform.incomingPort('updatecode', _elm_lang$core$Json_Decode$string);
var _user$project$Main$prompt = _elm_lang$core$Native_Platform.incomingPort('prompt', _elm_lang$core$Json_Decode$string);
var _user$project$Main$Model = F5(
	function (a, b, c, d, e) {
		return {totalItems: a, pageId: b, lesson: c, code: d, output: e};
	});
var _user$project$Main$Set = function (a) {
	return {ctor: 'Set', _0: a};
};
var _user$project$Main$builder2messages = function (builder) {
...
var _user$project$Main$hash2messages = function (location) {
	return _user$project$Main$builder2messages(
...
var _user$project$Main$getPage = function (topic) {
	var url = A2(
		_elm_lang$core$Basics_ops['++'],
		'api/1/python/',
		A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$Basics$toString(topic),
			'.json'));
	return A3(
...
var _user$project$Main$init = function (topic) {
	return {
		ctor: '_Tuple2',
		_0: A5(_user$project$Main$Model, 0, topic, 'Loading...', '', ''),
		_1: _user$project$Main$getPage(topic)
	};
};
		...
		switch (_p2.ctor) {
			...
			case 'Tabbed':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Main$inserttab('null')
				};
			case 'NewContent':
				return {
					ctor: '_Tuple2',
			...
			case 'RunCode':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{output: ''}),
					_1: _user$project$Main$runcode(model.code)
				};
			case 'Output':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							output: A2(_elm_lang$core$Basics_ops['++'], model.output, _p2._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ClearOutput':
			...
			case 'PreviousPage':
				return {
					...
					_1: _user$project$Main$getPage(model.pageId - 1)
				};
			case 'NextPage':
				return {
					ctor: '_Tuple2',
			...
			case 'FetchSucceed':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{totalItems: _p2._0._0, lesson: _p2._0._1, code: _p2._0._2}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'FetchFail':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			...
			default:
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{pageId: _p3}),
					_1: _user$project$Main$getPage(_p3)
				};
		}
	});
var _user$project$Main$NextPage = {ctor: 'NextPage'};
var _user$project$Main$NewContent = function (a) {
	return {ctor: 'NewContent', _0: a};
};
var _user$project$Main$Output = function (a) {
...
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Main$output(_user$project$Main$Output),
				_user$project$Main$updatecode(_user$project$Main$NewContent),
				_user$project$Main$prompt(_user$project$Main$Prompt)
			]));
};
var _user$project$Main$ClearOutput = {ctor: 'ClearOutput'};
var _user$project$Main$RunCode = {ctor: 'RunCode'};
var _user$project$Main$PreviousPage = {ctor: 'PreviousPage'};
var _user$project$Main$Tabbed = {ctor: 'Tabbed'};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$project$Main$onTab(_user$project$Main$Tabbed),
				_elm_lang$html$Html_Attributes$style(
				_elm_lang$core$Native_List.fromArray(
					[
						A2(_user$project$Main_ops['=>'], 'flex', '1')
					])),
				_elm_lang$html$Html_Attributes$value(model.code)
			]),
		_elm_lang$core$Native_List.fromArray(
			[]));
};
var _user$project$Main$windowbox = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						A2(_user$project$Main_ops['=>'], 'flex', '1'),
						A2(_user$project$Main_ops['=>'], 'display', 'flex'),
						A2(_user$project$Main_ops['=>'], 'flex-direction', 'row'),
						A2(_user$project$Main_ops['=>'], 'margin', '10px')
					]))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				_user$project$Main$window,
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								(_elm_lang$core$Native_Utils.cmp(model.pageId, 0) > 0) ? _elm_lang$html$Html_Events$onClick(_user$project$Main$PreviousPage) : _elm_lang$html$Html_Attributes$disabled(true)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								(_elm_lang$core$Native_Utils.cmp(model.pageId, model.totalItems - 1) < 0) ? _elm_lang$html$Html_Events$onClick(_user$project$Main$NextPage) : _elm_lang$html$Html_Attributes$disabled(true)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('>')
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										A2(_user$project$Main_ops['=>'], 'margin', '0 auto')
									]))
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Introduction to Programming')
							]))
					]),
				_user$project$Main$tutorial(model)),
				A2(
				_user$project$Main$window,
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('tutorial.py')
							])),
						A2(
						_elm_lang$html$Html$button,
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onClick(_user$project$Main$RunCode)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
				...
				_user$project$Main$editor(model)),
				A2(
				_user$project$Main$window,
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onClick(_user$project$Main$ClearOutput)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
				...
				A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(model.output)
						])))
			]));
};
var _user$project$Main$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Nav$nav,
				_user$project$Main$windowbox(model)
			]));
};
var _user$project$Main$main = {
	main: _rgrempel$elm_route_url$RouteUrl$program(
		{
			delta2url: _user$project$Main$delta2hash,
			location2messages: _user$project$Main$hash2messages,
			init: _user$project$Main$init(0),
